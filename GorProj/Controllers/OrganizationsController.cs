...
namespace GorProj.Controllers
{
    public class OrganizationsController : Controller
    {
        ...
        public OrganizationsController(HoldingContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdOrganization,NameOrganization")] Organization organization)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdOrganization,NameOrganization")] Organization organization)
        {
